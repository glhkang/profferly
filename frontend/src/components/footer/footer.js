          ...
          <ul>
            <li className="footer-link">
              ...
              <ul className="dropdown">
                ...
                <li className="angel-button">
                  <a
                    href="https://angel.co/u/catherinekimyj"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Angellist
                ...
                <li className="git-button">
                  <a
                    href="https://github.com/catherinekimyj"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Github
            ...
            <li className="footer-link">
              ...
              <ul className="dropdown">
                ...
                <li className="angel-button">
                  <a
                    href="https://angel.co/emina-ramovic"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Angellist
                ...
                <li className="git-button">
                  <a
                    href="https://github.com/Emina288"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Github
            ...
            <li className="footer-link">
              ...
              <ul className="dropdown">
                <li id="profile-photo">
                  <img src="/assets/images/gloria-gradient.png" alt="gloria" />
                </li>
            ...
            <li className="footer-link">
              ...
              <ul className="dropdown">
                ...
                <li className="angel-button">
                  <a
                    href="https://angel.co/marikasanuki"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Angellist
