...
export function RawList(props, ref) {
  ...
  var _useHeights = useHeights(getKey, null, null),
      ...
      getInstanceRefFunc = _useHeights2[0],
  ...
  function onRawWheel(event) {
    if (!inVirtual) return; // Proxy of scroll events

    event.preventDefault();
    setScrollTop(function (top) {
      var newTop = keepInRange(top + event.deltaY);
  ...
  var listChildren = useChildren(mergedData, start, end, getInstanceRefFunc, children, sharedConfig);
